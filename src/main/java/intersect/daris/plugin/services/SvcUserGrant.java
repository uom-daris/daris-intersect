package intersect.daris.plugin.services;
 ...
 * intersect.daris:pssd.model.user role to an existing user. It calls
 * actor.grant service and it can be used as an example of plug-in service
 * development.
 * 
 *
 */
public class SvcUserGrant extends PluginService {
    ...
    public static final String SERVICE_NAME = "intersect.daris.user.grant";
